                ...
                <table class="w-full mb-4 text-sm">
                    ...
                    <tbody>
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $teamNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="border-b">
                                <td class="py-2"><?php echo e($team->name); ?></td>
                                <td class="py-2 text-right">
                                    <button type="button" class="text-xs text-blue-600 hover:underline mr-2" wire:click="showEditModal(<?php echo e($team->id); ?>)">Editar</button>
                                    <button type="button" class="text-xs text-red-600 hover:underline" wire:click="confirmDelete(<?php echo e($team->id); ?>)">Apagar</button>
                                </td>
                            </tr>
...
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-xs"><?php echo e($message == 'The name has already been taken.' ? 'O nome já existe.' : $message); ?></span> <?php unset($message);
...
<?php /**PATH C:\laragon\www\estaleiro\resources\views/livewire/team-name-crud.blade.php ENDPATH**/ ?>