            ...
            <div class="mb-4">
                ...
                <select wire:model.defer="leader_id" class="select2 w-full rounded border-gray-300" required>
                    ...
                    <option value="<?php echo e($emp->id); ?>">
                        <?php echo e(\App\Helpers\EmployeeAssignmentHelper::getLabelParaSelect($emp->id, $date, $editingTeamId ??
                        null)); ?>
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex gap-2 items-center">
                        <select wire:model.defer="dailyTeamMembers.<?php echo e($i); ?>.employee_id" class="select2 w-full rounded border-gray-300">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($emp->id); ?>"><?php echo e(\App\Helpers\EmployeeAssignmentHelper::getLabelParaSelect($emp->id, $date,
                                $editingTeamId ?? null)); ?>
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex gap-2 items-center">
                        <select wire:model.defer="dailyTeamVehicles.<?php echo e($i); ?>.vehicle_id" class="select2 w-full rounded border-gray-300">
                            ...
                            <option value="<?php echo e($veh->id); ?>">
                                <?php echo e(\App\Helpers\VehicleAssignmentHelper::getLabelParaSelect($veh->id, $date,
                                $editingTeamId ?? null)); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div class="mb-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex gap-2 items-center">
                                <select class="select2 select2-subveh w-full rounded border-gray-300"
                                        wire:model.defer="subTeams.<?php echo e($s); ?>.vehicles.<?php echo e($v); ?>.vehicle_id">
                                        <option value="">Selecione veículo...</option>
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $veh): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($veh->id); ?>">
                                            <?php echo e(\App\Helpers\VehicleAssignmentHelper::getLabelParaSelect($veh->id,
                                             $date, $editingTeamId ?? null)); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
        ...
        <div class="flex gap-2 mt-8 justify-end">
            <button type="submit" class="bg-blue-700 hover:bg-blue-800 text-white font-semibold py-2 px-4 rounded shadow
                transition">
                <!--[if BLOCK]><![endif]--><?php if($editingTeamId): ?>
                Guardar cambios
                <?php else: ?>
            ...
            <button type="button" wire:click="cancel" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-4 rounded shadow transition">Cancelar</button>
            <!--[if BLOCK]><![endif]--><?php if($editingTeamId): ?>
            <button type="button" wire:click="openDeleteDailyTeamModal(<?php echo e($editingTeamId); ?>)"
                class="bg-red-600 hover:bg-red-700 text-white font-semibold py-2 px-4 rounded shadow transition">Eliminar
                equipa diária</button>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        </div>

        <!--[if BLOCK]><![endif]--><?php if($showDeleteDailyTeamModal): ?>
        <div class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
            <div class="bg-white p-6 rounded shadow w-full max-w-md">
                <h2 class="text-lg font-bold mb-4 text-red-600">Eliminar equipa diária</h2>
                <p class="mb-4">Esta ação irá apagar permanentemente a equipa diária e todos os seus membros, veículos e
                    subgrupos. Tem a certeza que deseja continuar?</p>
                <div class="flex justify-end gap-2 mt-4">
                    <button type="button" wire:click="closeDeleteDailyTeamModal"
                        class="px-3 py-1 bg-gray-400 text-white rounded">Cancelar</button>
                    <button type="button" wire:click="deleteDailyTeam"
...
$__html = app('livewire')->mount($__name, $__params, 'lw-4261308824-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-4261308824-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-4261308824-2', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\laragon\www\estaleiro\resources\views/livewire/daily-teams/daily-team-form.blade.php ENDPATH**/ ?>