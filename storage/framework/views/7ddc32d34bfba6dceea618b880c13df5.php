...
[$__name, $__params] = $__split('daily-teams.daily-team-form', $params);

$__html = app('livewire')->mount($__name, $__params, 'lw-2529976617-0', $__slots ?? [], get_defined_vars());
...
?>
        ...
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        <!--[if BLOCK]><![endif]--><?php if($showImportLastWorkDayModal): ?>
        <div class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
            <div class="bg-white p-6 rounded shadow w-full max-w-md">
...
<?php /**PATH C:\laragon\www\estaleiro\resources\views/livewire/daily-teams/daily-teams-index.blade.php ENDPATH**/ ?>