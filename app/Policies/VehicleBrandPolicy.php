...
class VehicleBrandPolicy
{
    ...
    {
        return $user->can('delete_any_vehicle::brand');
    }
    ...
    {
        return $user->can('force_delete_vehicle::brand');
    }
    ...
    {
        return $user->can('force_delete_any_vehicle::brand');
    }
    ...
    {
        return $user->can('restore_vehicle::brand');
    }
    ...
    {
        return $user->can('restore_any_vehicle::brand');
    }
    ...
    {
        return $user->can('replicate_vehicle::brand');
    }
    ...
    {
        return $user->can('reorder_vehicle::brand');
    }
}
