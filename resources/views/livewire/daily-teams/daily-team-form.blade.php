<div class="p-6">
        ...
        <section class=" border border-yellow-600 p-4 rounded mb-6">
            ...
            <div class="mb-4">
                ...
                <select wire:model.defer="leader_id" class="select2 w-full rounded border-gray-300" required>
                    ...
                    <option value="{{ $emp->id }}">
                        {{ \App\Helpers\EmployeeAssignmentHelper::getLabelParaSelect($emp->id, $date, $editingTeamId ??
                        null) }}
                    </option>
                    @endforeach
                </select>
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex gap-2 items-center">
                        <select wire:model.defer="dailyTeamMembers.{{ $i }}.employee_id" class="select2 w-full rounded border-gray-300">
                            ...
                            @foreach($employees as $emp)
                            <option value="{{ $emp->id }}">{{
                                \App\Helpers\EmployeeAssignmentHelper::getLabelParaSelect($emp->id, $date,
                                $editingTeamId ?? null) }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex gap-2 items-center">
                        <select wire:model.defer="dailyTeamVehicles.{{ $i }}.vehicle_id" class="select2 w-full rounded border-gray-300">
                            ...
                            <option value="{{ $veh->id }}">
                                {{ \App\Helpers\VehicleAssignmentHelper::getLabelParaSelect($veh->id, $date,
                                $editingTeamId ?? null) }}
                            </option>
                            @endforeach
                        </select>
                        ...
                        <div class="mb-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <select class="select2 select2-subveh w-full rounded border-gray-300"
                                        wire:model.defer="subTeams.{{ $s }}.vehicles.{{ $v }}.vehicle_id">
                                        <option value="">Selecione veículo...</option>
                                        @foreach($vehicles as $veh)
                                        <option value="{{ $veh->id }}">
                                            {{ \App\Helpers\VehicleAssignmentHelper::getLabelParaSelect($veh->id,
    ...
    {{-- ///////////////////////////////////////////////////////////////////////////////////////// --}}
        ...
        <div class="flex gap-2 mt-8 justify-end">
            ...
            @if($editingTeamId)
            <button type="button" wire:click="openDeleteDailyTeamModal({{ $editingTeamId }})"
